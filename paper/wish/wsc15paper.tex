...
To simplify our analysis, we analyze a slight modification of the version of the BIZ procedure presented in \cite{Frazier:BIZ}, which keeps a certain parameter $\lambda^2_z$ fixed rather than letting it vary as did \cite{Frazier:BIZ}.  Numerical experiments on typical cases show little difference in performance between the version of BIZ we analyze and the version in \citeN{Frazier:BIZ}.
...
set and this remaining alternative is chosen as the best. 
