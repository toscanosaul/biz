...
that eliminates the use of Bonferroni's inequality, reducing conservatism. \mathcal
...
we recall the Bayes-inspired IZ (BIZ) procedure from \citeN{Frazier:BIZ}. In $\mathsection$\ref{proof},
