...
%
\WSCpagesetup{Toscano-Palmerin, Frazier}
...
Two other common sources of conservatism are the change from discrete-time processes to continuous-time processes used to show IZ guarantees, and the fact that typically, the configuration under consideration is not a worst-case configuration \cite{kim:20062}.  
This last source tends to be the largest in terms of its contribution to conservatism, and the first tends to be the smallest, with the contribution from Bonferonni inequality's lying between \cite{kim:20062}.
