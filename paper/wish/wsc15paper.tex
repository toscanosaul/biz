...
% Even though this proof does not guarantee that the algorithm will satisfy the indifference-zone guarantee for configurations with large $\delta$, the theorem shows that it will work well when the alternatives are not very different, which are the most difficult cases. 
