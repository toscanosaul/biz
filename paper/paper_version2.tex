...
The same distribution over selection decision will result if we apply
the same same selection process to the following time process with
jumps at $t\in\left\{ 0,\delta^{2},2\delta^{2},\ldots\right\} =\delta^{2}\mathbb{N}$,
\[
...
\]
the previous equation is true because 
\[
