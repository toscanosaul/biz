% Run KNUNK on a problem, and save the result to a file.
%
% Inputs:
...
function [xstar, nsamples, nstages] = Oct18_RunKNOnce(problem, k, seed_start)
...
Pstar = 0.9;
delta = 1;
[xstar, nsamples, nstages] = KNUNK(fn, fn_runlength, fn_other, alts(1:k,:), Pstar, delta, seed_start, seed_skip);
outfile = sprintf('Oct18/KN_%s_%d_%d.mat', problem, k, seed_start);
