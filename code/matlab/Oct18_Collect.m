...
% [est_Nk, stderr_Nk, est_PGS, stderr_PGS] = Oct18_Collect(alg, problem, k, max_seed)
% 
% for example, Oct18_Collect('BIZ', 'SC', 8, 100) would check the results of
...
for seed=1:max_seed
	infile = sprintf('Oct18/%s_%s_%d_%d.mat', alg, problem, k, seed);
